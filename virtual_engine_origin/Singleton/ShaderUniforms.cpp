...
namespace SCompile
{
	...
	void GetVarData(const vengine::string& s, bool useCount, char registerType, uint& count, uint& regis, uint& space, vengine::string& name)
	{
		vengine::string data;
		space = 0;
		regis = 0;
	...
	void GetShaderRootSigData(const vengine::string& path, vengine::vector<ShaderVariable>& vars, vengine::vector<PassDescriptor>& passes)
	{
		vars.clear();
		vars.reserve(20);
		passes.clear();
		...
		char c[256];
		vengine::string s;
		static vengine::string rwtex = "RWT";
		static vengine::string rwstr = "RWS";
		static vengine::string cbuffer = "cbuffer";
		static vengine::string tex = "Tex";
		static vengine::string str = "Str";
		static vengine::string pragma = "#pragma";
		static vengine::string endPragma = "#end";
		static vengine::string vertex = "vertex";
		static vengine::string fragment = "fragment";
		static vengine::string Cull = "cull";
		static vengine::string zWrite = "zwrite";
		static vengine::string zTest = "ztest";
		static vengine::string conservative = "conservative";
		static vengine::string blend = "blend";
	...
	void GetComputeShaderRootSigData(const vengine::string& path, vengine::vector<ComputeShaderVariable>& vars, vengine::vector<vengine::string>& passes)
	{
		vars.clear();
		vars.reserve(20);
		passes.clear();
