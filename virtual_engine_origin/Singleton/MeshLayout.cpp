...
HashMap<USHORT, UINT> MeshLayout::layoutDict(113);
vengine::vector<ArrayList<D3D12_INPUT_ELEMENT_DESC>*> MeshLayout::layoutValues;
...
)
{
	...
	if (!ite)
	{
		...
		layoutDict.Insert(value, layoutValues.size());
