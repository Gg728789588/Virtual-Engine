...
bool DLL_CLASS ReadJson(const vengine::string& filePath, neb::CJsonObject* placementMemory);
double DLL_CLASS GetDoubleFromChar(char* c, size_t t);
float DLL_CLASS GetFloatFromChar(char* c, size_t t);
int DLL_CLASS GetIntFromChar(char* c, size_t t);
void DLL_CLASS ReadJson(const vengine::string& filePath, StackObject<neb::CJsonObject, true>& placementPtr);
template <typename T>
