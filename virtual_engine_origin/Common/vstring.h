...
namespace vengine
{
	...
	_Elem* UIntegral_to_buff(_Elem* _RNext, _UTy _UVal) { // format _UVal into buffer *ending at* _RNext
	...
	template <class _Ty>
	inline string IntegerToString(const _Ty _Val) { // convert _Val to string
	...
	inline string to_string(int32_t _Val)
	{
		return IntegerToString(_Val);
	}
	inline string to_string(uint32_t _Val)
	{
		return IntegerToString(_Val);
	}
	inline string to_string(int16_t _Val)
	{
		return IntegerToString(_Val);
	}
	inline string to_string(uint16_t _Val)
	{
		return IntegerToString(_Val);
	}
	inline string to_string(int8_t _Val)
	{
		return IntegerToString(_Val);
	}
	inline string to_string(uint8_t _Val)
	{
		return IntegerToString(_Val);
	}
	...
	template <class _Ty>
	inline wstring IntegerToWString(const _Ty _Val) { // convert _Val to string
		static_assert(std::is_integral_v<_Ty>, "_Ty must be integral");
		using _UTy = std::make_unsigned_t<_Ty>;
	...
	inline wstring to_wstring(double _Val) { // convert double to wstring
	...
	inline wstring to_wstring(int32_t _Val)
	{
		return IntegerToWString(_Val);
	}
	inline wstring to_wstring(uint32_t _Val)
	{
		return IntegerToWString(_Val);
	}
	inline wstring to_wstring(int16_t _Val)
	{
		return IntegerToWString(_Val);
	}
	inline wstring to_wstring(uint16_t _Val)
	{
		return IntegerToWString(_Val);
	}
	inline wstring to_wstring(int8_t _Val)
	{
		return IntegerToWString(_Val);
	}
	inline wstring to_wstring(uint8_t _Val)
	{
		return IntegerToWString(_Val);
	}
	inline wstring to_wstring(int64_t _Val)
	{
		return IntegerToWString(_Val);
	}
	inline wstring to_wstring(uint64_t _Val)
	{
		return IntegerToWString(_Val);
	}
}
...
inline vengine::string operator+(char c, const vengine::string& str)
{
	return vengine::string(c, str);
}

inline vengine::string operator+(const char* c, const vengine::string& str)
{
	return vengine::string(c, str);
}

inline vengine::wstring operator+(wchar_t c, const vengine::wstring& str)
{
	return vengine::wstring(c, str);
}

inline vengine::wstring operator+(const wchar_t* c, const vengine::wstring& str)
{
	return vengine::wstring(c, str);
}
...
namespace std
{
	...
	struct hash<vengine::string>
	{
		...
		{
			return _Hash_array_representation(str.c_str(), str.size());
		}
	};
	template <>
