...
DxException::DxException(HRESULT hr, const vengine::wstring& functionName, const vengine::wstring& filename, int lineNumber) :
	ErrorCode(hr),
...
ComPtr<ID3DBlob> d3dUtil::LoadBinary(const vengine::wstring& filename)
{
...
vengine::wstring DxException::ToString()const
{
