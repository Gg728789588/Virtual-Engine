...
/*void CullTask::ScheduleCullingJob(vengine::vector<MeshRenderer*>* targets, DirectX::XMVECTOR* cullingPlanes, tf::Taskflow& flow)
{
...
vengine::vector<CullTask::CullingResult>* CullTask::GetCullingResult()
{
