...
TextureHeap::TextureHeap(ID3D12Device* device, uint64_t chunkSize, bool isRenderTexture) :
	chunkSize(chunkSize)
{
...
void TextureHeap::Create(ID3D12Device* device, uint64_t chunkSize, bool isRenderTexture)
{
